...
class SourceAdapter(ABC):
    ...
    def _record(self, *, raw: dict[str, Any], observed_at: str, dataset_id: str, version_id: str | None, name: object, url: object, description: object, tasks: object = None, modalities: object = None, tags: object = None, sample_count: object = None, class_count: object = None, license_claim: object = None, creators: object = None, citation: object = None, documentation_url: object = None, downloads: object = None, stars: object = None, formats: object = None, splits: object = None, feature_info: object = None, family_id: object = None, lineage: object = None, raw_reference: str = "fixture") -> CanonicalDataset:
        ...
        record = CanonicalDataset(
            ...
            governance={"license_claim": normalize_text(license_claim), "usage_policy": None, "creators": creators or [], "citation": normalize_text(citation), "documentation_url": normalize_url(str(documentation_url)) if documentation_url else canonical_url, "provenance_urls": [canonical_url] if canonical_url else [], "croissant_url": None},
